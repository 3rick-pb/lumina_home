      ...
      <div className="w-full max-w-md relative z-10">
        <div className="bg-white/50 backdrop-blur-2xl border border-white/80 p-8 sm:p-10 rounded-[2.5rem] shadow-[0_12px_40px_rgba(0,0,0,0.06)]">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            >
              {isLoading ? (
                <div className="flex items-center justify-center gap-3">
                  <BeUILoaderMetaballs size={34} className="text-white" />
            ...
            {isLoading && (
              <div className="mt-3 py-3.5 px-4 rounded-2xl bg-white/95 backdrop-blur-2xl border border-gray-200/80 shadow-[0_10px_30px_rgba(0,0,0,0.07)] flex flex-col items-center justify-center gap-1.5 animate-fade-in">
                <BeUILoaderMetaballs size={46} className="text-gray-950" />
                <span className="text-[11px] font-semibold tracking-wider text-gray-600">
