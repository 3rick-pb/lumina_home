...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen pt-32 pb-24 flex items-center justify-center bg-[#f8f9fa] relative overflow-hidden">
      ...
      <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-white rounded-full blur-[120px] opacity-60 mix-blend-overlay pointer-events-none" />
      <div className="absolute bottom-1/4 right-1/4 w-[500px] h-[500px] bg-[#8c9276] rounded-full blur-[150px] opacity-20 pointer-events-none" />
