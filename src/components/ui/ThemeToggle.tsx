      ...
      {options.map((option) => {
        ...
        return (
          <button
            ...
            className={`relative z-10 flex-1 flex items-center justify-center gap-2 py-3 text-[13px] font-bold transition-all duration-700 cursor-pointer ${
