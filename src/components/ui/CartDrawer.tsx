...
export function CartDrawer() {
 ...
 {/* Top Bar Header */}
 <header className="px-6 sm:px-8 py-4 bg-white dark:bg-[#1a1a1a]/80 backdrop-blur-xl border-b border-gray-100 dark:border-white/5 flex items-center justify-between shrink-0 shadow-sm dark:shadow-none">
 ...
 <div className="flex items-center gap-2 bg-gray-100 dark:bg-[#121212]/5/80 p-1 rounded-2xl">
 <button 
 onClick={() => setStep("bag")}
 className={`px-3.5 py-1 rounded-xl text-xs font-bold transition-all ${
 step === "bag" ? "bg-white dark:bg-[#1a1a1a] text-gray-900 dark:text-gray-100 shadow-sm dark:shadow-none" : "text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:text-gray-100 "
 }`}
 >
 ...
 step === "payment" ? "bg-white dark:bg-[#1a1a1a] text-gray-900 dark:text-gray-100 shadow-sm dark:shadow-none" : "text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:text-gray-100 "
 }`}
 >
 2. Pasarela de Pago
 </button>
 ...
 <button 
 onClick={() => setIsOpen(false)}
 className="px-4 py-1.5 rounded-xl bg-gray-100 dark:bg-[#121212]/5 hover:bg-gray-200 dark:bg-[#121212]/10 text-xs font-semibold text-gray-700 dark:text-gray-300 transition-colors flex items-center gap-1.5"
 >
 <span>Cerrar</span>
 ...
 {/* ---------------------------------------------------- */}
 <div className="lg:col-span-8 bg-white dark:bg-[#1a1a1a]/80 backdrop-blur-xl rounded-[2rem] border border-gray-200 dark:border-white/10/60 p-6 sm:p-8 shadow-sm dark:shadow-none space-y-6">
 ...
 <div className="relative w-20 h-20 sm:w-24 sm:h-24 rounded-2xl overflow-hidden bg-gray-100 dark:bg-[#121212]/5 shrink-0 border border-white shadow-sm dark:shadow-none">
 <Image 
 ...
 {item.color && (
 <span className="px-2 py-0.5 rounded-lg bg-gray-100 dark:bg-[#121212]/5 text-[11px]">
 {item.color}
 </span>
 )}
 {item.size && (
 ...
 <div className="flex items-center bg-gray-100 dark:bg-[#121212]/5/90 rounded-full px-2.5 py-1.5 border border-gray-200 dark:border-white/10/70 shadow-inner">
 <button 
 ...
 itemIsAgotado 
 ? "bg-gray-200 dark:bg-[#121212]/10 text-gray-400 dark:text-gray-400 cursor-not-allowed opacity-40" 
 ...
 {/* ---------------------------------------------------- */}
 <div className="lg:col-span-4 bg-white dark:bg-[#1a1a1a]/90 backdrop-blur-2xl rounded-[2rem] border border-gray-200 dark:border-white/10/70 p-6 sm:p-7 shadow-lg dark:shadow-none shadow-gray-200/50 space-y-6">
 ...
 <div className="w-full h-1.5 bg-gray-200 dark:bg-[#121212]/10 rounded-full overflow-hidden">
 <div 
 ...
 className="p-4 rounded-2xl bg-white dark:bg-[#1a1a1a]/70 hover:bg-white dark:bg-[#1a1a1a] border border-gray-100 dark:border-white/5 hover:border-gray-200 dark:border-white/10 shadow-sm dark:shadow-none transition-all cursor-pointer flex items-center gap-3.5 group"
 >
 <div className="relative w-16 h-16 rounded-xl overflow-hidden bg-gray-100 dark:bg-[#121212]/5 shrink-0">
 ...
 {/* Shipping Address */}
 <div className="p-6 rounded-[2rem] bg-white dark:bg-[#1a1a1a] border border-gray-200 dark:border-white/10/70 shadow-sm dark:shadow-none space-y-4">
 <div className="flex items-center justify-between">
 <div className="flex items-center gap-2">
 <MapPin className="w-4 h-4 text-blue-600" />
 <h4 className="font-bold text-sm text-gray-900 dark:text-gray-100 ">Dirección de Entrega</h4>
 {addresses.length > 0 && (
 <span className="text-[10px] font-mono font-semibold px-2 py-0.5 rounded-full bg-gray-100 dark:bg-[#121212]/5 text-gray-600 dark:text-gray-400 border border-gray-200 dark:border-white/10">
 {addresses.length}/4
 </span>
 )}
 </div>
 ...
 {locationError && (
 <p className="text-[11px] text-amber-800 bg-a dark:bg-[#121212]mber-50 border border-amber-200 rounded-xl p-2 mt-1.5 leading-tight">
 {locationError}
 </p>
 )}
 ...
 type="button"
 onClick={() => setIsEditingAddress(false)}
 className="w-1/3 py-2.5 bg-gray-100 dark:bg-[#121212]/5 text-gray-700 dark:text-gray-300 rounded-xl text-xs font-semibold hover:bg-gray-200 dark:bg-[#121212]/10 transition-colors cursor-pointer"
 >
 Cancelar
 </button>
 <button 
 ...
 <div className="p-4 rounded-2xl bg-a dark:bg-[#121212]mber-50/70 border border-amber-200 text-center space-y-2">
 ...
 className="px-4 py-1.5 bg-a dark:bg-[#121212]mber-900 text-white dark:text-gray-900 rounded-xl text-xs font-semibold cursor-pointer"
 >
 ...
 <div className="p-6 rounded-[2rem] bg-white dark:bg-[#1a1a1a] border border-gray-200 dark:border-white/10/70 shadow-sm dark:shadow-none space-y-5">
 <div className="flex items-center justify-between pb-1 border-b border-gray-100 dark:border-white/5">
 <div className="flex items-center gap-2">
 ...
 <div className="p-6 sm:p-8 rounded-3xl bg-white dark:bg-[#1a1a1a] border border-gray-200 dark:border-white/10 shadow-sm dark:shadow-none flex flex-col items-center justify-center text-center space-y-4">
 ...
 <div className="w-16 h-16 rounded-2xl bg-white dark:bg-[#1a1a1a] border border-blue-100 flex items-center justify-center shadow-sm dark:shadow-none">
 ...
 <div className="lg:col-span-5 bg-white dark:bg-[#1a1a1a] p-6 sm:p-7 rounded-[2rem] border border-gray-200 dark:border-white/10/70 shadow-lg dark:shadow-none space-y-5">
 ...
 {/* Receipt Card */}
 <div className="w-full p-6 sm:p-8 rounded-3xl bg-white dark:bg-[#1a1a1a] border border-gray-100 dark:border-white/5 shadow-md dark:shadow-none text-left space-y-4">
 ...
 className="w-full py-3.5 bg-gray-100 dark:bg-[#121212]/5 hover:bg-gray-200 dark:bg-[#121212]/10 text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-white/10/80 rounded-2xl text-xs sm:text-sm font-semibold transition-all shadow-sm dark:shadow-none"
 >
