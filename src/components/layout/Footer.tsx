    ...
    <footer id="envios-garantias" className={`${isAuthPage ? "mt-0 bg-transparent border-t border-gray-200/40 dark:border-white/5" : "mt-24 border-t border-black/[0.06] dark:border-white/[0.06] bg-[#fbfbfa] dark:bg-[#141416]"} pt-16 pb-12 transition-colors duration-300 scroll-mt-10`}>
      <div className="container mx-auto px-4 md:px-6">
        ...
        {!isAuthPage && (
          <div className="mb-14 sm:mb-20 relative overflow-hidden rounded-2xl sm:rounded-[2.5rem] bg-white/70 dark:bg-[#18181b]/70 backdrop-blur-3xl border border-black/[0.07] dark:border-white/[0.08] shadow-[0_20px_50px_rgba(0,0,0,0.03),0_4px_16px_rgba(0,0,0,0.02)] transition-all duration-500">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-black/[0.05] dark:divide-white/[0.05]">
              ...
              <div className="p-5 sm:p-8 md:p-9 flex flex-col justify-between space-y-4 group hover:bg-black/[0.015] dark:hover:bg-white/[0.015] transition-colors">
                <div className="space-y-3.5">
                  <div className="flex items-center justify-between">
                    <div className="w-12 h-12 sm:w-13 sm:h-13 rounded-2xl bg-[#8c9276]/15 dark:bg-[#8c9276]/25 text-[#8c9276] dark:text-[#a8b092] flex items-center justify-center transition-transform duration-300 group-hover:scale-105 shadow-xs">
              ...
              <div className="p-5 sm:p-8 md:p-9 flex flex-col justify-between space-y-4 group hover:bg-black/[0.015] dark:hover:bg-white/[0.015] transition-colors">
                <div className="space-y-3.5">
                  <div className="flex items-center justify-between">
                    <div className="w-12 h-12 sm:w-13 sm:h-13 rounded-2xl bg-emerald-500/15 dark:bg-emerald-500/25 text-emerald-600 dark:text-emerald-400 flex items-center justify-center transition-transform duration-300 group-hover:scale-105 shadow-xs">
              ...
              <div className="p-5 sm:p-8 md:p-9 flex flex-col justify-between space-y-4 group hover:bg-black/[0.015] dark:hover:bg-white/[0.015] transition-colors">
                <div className="space-y-3.5">
                  <div className="flex items-center justify-between">
                    <div className="w-12 h-12 sm:w-13 sm:h-13 rounded-2xl bg-blue-500/15 dark:bg-blue-500/25 text-blue-600 dark:text-blue-400 flex items-center justify-center transition-transform duration-300 group-hover:scale-105 shadow-xs">
        ...
        <div className="grid grid-cols-2 gap-6 sm:gap-8 md:grid-cols-4 lg:grid-cols-5">
          ...
          <div>
            <h3 className="text-xs sm:text-sm font-semibold text-gray-900 dark:text-gray-100 uppercase tracking-wider">Tienda</h3>
            <ul className="mt-3 sm:mt-4 space-y-2.5 sm:space-y-3">
              <li><a href="#" className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 hover:text-accent-600 dark:hover:text-accent-400 transition-colors">Novedades</a></li>
              <li><a href="#" className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 hover:text-accent-600 dark:hover:text-accent-400 transition-colors">Salón</a></li>
              <li><a href="#" className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 hover:text-accent-600 dark:hover:text-accent-400 transition-colors">Dormitorio</a></li>
              <li><a href="#" className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 hover:text-accent-600 dark:hover:text-accent-400 transition-colors">Accesorios</a></li>
            </ul>
          </div>
          <div>
          ...
          <div>
            <h3 className="text-xs sm:text-sm font-semibold text-gray-900 dark:text-gray-100 uppercase tracking-wider">Legal</h3>
            <ul className="mt-3 sm:mt-4 space-y-2.5 sm:space-y-3">
              <li><a href="#" className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 hover:text-accent-600 dark:hover:text-accent-400 transition-colors">Aviso Legal</a></li>
              <li><a href="#" className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 hover:text-accent-600 dark:hover:text-accent-400 transition-colors">Política de Privacidad</a></li>
              <li><a href="#" className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 hover:text-accent-600 dark:hover:text-accent-400 transition-colors">Términos de Servicio</a></li>
            </ul>
          </div>
        </div>
