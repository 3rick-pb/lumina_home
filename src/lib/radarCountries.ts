...
export const RADAR_COUNTRIES: Record<RadarCountryCode, RadarCountryMeta> = {
  EC: {
    ...
    name: 'Ecuador',
    flag: '🇪🇨',
    aspectRatioClass: 'aspect-[1024/682]',
    aspectRatioValue: 1024 / 682,
    width: 1024,
    height: 682,
  ...
  AR: {
    ...
    name: 'Argentina',
    flag: '🇦🇷',
    aspectRatioClass: 'aspect-[861/1024]',
    aspectRatioValue: 861 / 1024,
    width: 861,
    height: 1024,
  ...
  PE: {
    ...
    name: 'Perú',
    flag: '🇵🇪',
    aspectRatioClass: 'aspect-[1024/948]',
    aspectRatioValue: 1024 / 948,
    width: 1024,
    height: 948,
  ...
  MX: {
    ...
    name: 'México',
    flag: '🇲🇽',
    aspectRatioClass: 'aspect-[1024/596]',
    aspectRatioValue: 1024 / 596,
    width: 1024,
    height: 596,
  ...
  CL: {
    ...
    name: 'Chile',
    flag: '🇨🇱',
    aspectRatioClass: 'aspect-[1024/943]',
    aspectRatioValue: 1024 / 943,
    width: 1024,
    height: 943,
